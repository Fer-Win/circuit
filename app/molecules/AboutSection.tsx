...
const AboutSection = () => {
  return (
    <div id='#about' className='w-full flex flex-wrap justify-around px-28 gap-y-8  gap-x-20 my-16'>
        ...
        <AboutCard src='/vercel.svg' title='Access to Exclusive Resources and Tools'  description='Unlock a wealth of exclusive tutorials, courses, and cutting-edge development tools to enhance your skills.'/>
